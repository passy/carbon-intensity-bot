    ...
    nock("https://api.co2signal.com:443", nockOptions)
      ...
      .reply(
        200,
        {
          ...
          countryCode: "GB",
          data: { carbonIntensity: 309.576875210522, fossilFuelPercentage: 57.535976307849836 },
          status: "ok",
    ...
    nock("https://api.co2signal.com:443", nockOptions)
      ...
      .reply(
        200,
        {
          ...
          _disclaimer: "This data is the exclusive property of Tomorrow and/or related parties. If you're in doubt about your rights to use this data, please contact hello@tmrow.com",
          countryCode: "GB",
          data: { carbonIntensity: 304.99784296701154, fossilFuelPercentage: 57.00487986790134 },
          status: "ok",
          units: { carbonIntensity: "gCO2eq/kWh" },
        },
    ...
    nock("https://api.co2signal.com:443", nockOptions)
      ...
      .reply(
        200,
        {
          ...
          _disclaimer: "This data is the exclusive property of Tomorrow and/or related parties. If you're in doubt about your rights to use this data, please contact hello@tmrow.com",
          countryCode: "GB",
          data: { carbonIntensity: 323.2486027569276, fossilFuelPercentage: 60.86738754100338 },
          status: "ok",
          units: { carbonIntensity: "gCO2eq/kWh" },
        },
        [
